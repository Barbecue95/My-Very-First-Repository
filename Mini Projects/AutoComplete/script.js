...
const nagigateAndSelect = (key) => {  
  if (key === "ArrowDown"){
    ...
    const enteredProduct = selected(indexToSelect);
    resultContainerTag.innerHTML = "";
    resultContainerTag.append(enteredProduct);
    deselected();
    return;
  }
}
...
const selected = (index) => {
  ...
  const selectDiv = document.getElementById(productIdToSelect);
  selectDiv.style.backgroundColor = "#237BFF";
...
const deselected = () => {
  ...
  productIdToDeselect.style.backgroundColor = "#fff";
  productIdToDeselect.style.color = "#000";
